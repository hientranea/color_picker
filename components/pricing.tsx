  ...
  return (
    <section id="pricing" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center text-gray-600 mb-12">Start free and upgrade when you need more power</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Free Plan */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 transition-transform duration-300 hover:transform hover:scale-105">
            <div className="p-8 bg-gray-50 border-b border-gray-200">
              ...
              <p className="mt-4 text-center text-gray-600">Essential color picking tools for everyday use</p>
            </div>
            <div className="p-8">
              <PricingFeature included={true} text="Basic color picker tool" />
              <PricingFeature included={true} text="HEX, RGB, and HSL formats" />
              <PricingFeature included={true} text="Save up to 5 color palettes" />
              <PricingFeature included={true} text="Basic color harmony generation" />
              <PricingFeature included={true} text="Recent colors history" />
              <PricingFeature included={false} text="AI-assisted palette generation" />
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden border-2 border-purple-500 transform scale-105 z-10">
            <div className="p-8 bg-purple-50 border-b border-purple-100 relative">
              ...
              <p className="mt-4 text-center text-gray-600">Professional color tools for serious designers</p>
            </div>
            <div className="p-8">
              <PricingFeature included={true} text="Everything in Free plan" />
              <PricingFeature included={true} text="Unlimited color palettes" />
              <PricingFeature included={true} text="AI-assisted palette generation" />
              <PricingFeature included={true} text="Cloud synchronization across devices" />
              <PricingFeature included={true} text="Advanced color harmony tools" />
              <PricingFeature included={true} text="Image color extraction" />
              <PricingFeature included={true} text="Accessibility contrast checking" />
              <PricingFeature included={true} text="Color name suggestions" />
              <PricingFeature included={true} text="Export in multiple formats" />
        ...
        <p className="text-center text-gray-500 mt-8">Start with the free version and upgrade anytime. No credit card required to get started.</p>
      </div>
    </section>
  );
}